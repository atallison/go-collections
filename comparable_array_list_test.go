...
func TestComparableArrayList_Remove(t *testing.T) {
...
func TestComparableArrayList_Contains(t *testing.T) {
	al := NewComparableArrayList[int]()
...
func TestComparableArrayList_IndexOf(t *testing.T) {
	al := NewComparableArrayList[int]()
	al.AddAll([]int{1, 2, 3, 1, 2, 3})
...
func TestComparableArrayList_LastIndexOf(t *testing.T) {
	al := NewComparableArrayList[int]()
	al.AddAll([]int{1, 2, 3, 1, 2, 3})
